...
internal class GreetingsKtTest {
    ...
    @Test
    fun `Greeting should handle all names when multiple names are provided`(){

        assertThat(greetings(listOf("Bob", "Susan", "Rachel"))).isEqualTo("Hello, Bob, Susan and Rachel")
    }
